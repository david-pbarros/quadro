...
import br.com.dbcorp.quadro.ui.equipeServico.DesignacoesUI;

public class EquipeServicoAction extends Action {
	private static final long serialVersionUID = -1900363790893943261L;

	public static final String NAME_VALUE = "Equipe Serviço";
	...
	//Descrição do menu
	public static final String SHORT_DESCRIPTION_VALUE = "Equipe Serviço";
	
	public EquipeServicoAction(MainFrame mainFrame) {
