...
import br.com.dbcorp.quadro.ui.discurso.DesignacoesUI;

public class DiscursoAction extends Action {
	private static final long serialVersionUID = -1900363790893943261L;

	public static final String NAME_VALUE = "Discurso";
	...
	//Descrição do menu
	public static final String SHORT_DESCRIPTION_VALUE = "Discurso Publico";
	
	public DiscursoAction(MainFrame mainFrame) {
